...
public interface GetCartItemDtoMapper {
    ...
    GetCartItemDto.Response toResponse(CartItem cartItem);
    ...
    GetCartItemDto.Response.GetSelectedOptionDto toGetSelectedOptionDto(SelectedOption selectedOption);
    ...
    GetCartItemDto.Response.GetSelectedOptionDto.GetCartOptionGroupDto toGetCartOptionGroupDto(
    ...
    GetCartItemDto.Response.GetSelectedOptionDto.GetCartOptionGroupDto.GetCartOptionDto toGetCartOptionDto(
