...
public enum UserErrorCode {
	...
	PASS_VALIDATION_ERROR("JJ1000", "Password validation error"),
	WRONG_PASSWORD_FORMAT("JJ1001", "Wrong password format"),
	PASSWORD_NOT_CHANGED("JJ1002", "Password is same as the old password");
