...
public interface ReviewRepository extends JpaRepository<Review, UUID> {
    ...
    @Query(value = "select * from review r join pickup_order_selected_option where r.pickup_order_selected_option_id = :pickupOrderSelectedOptionId", nativeQuery = true)
