--- 상품 등록
INSERT INTO item(id, name, price, is_deleted, seller_seller_id, category_id, created_at) VALUES (UUID'169f84f8-8862-477c-ad27-0b79871deb27', '로토 스르르트 썸머 슈즈', 81000, 0, UUID'2d68d1d0-ed27-46d2-b858-da3f0aa2e430', 8, '2019-08-25 12:36:04');
insert into item (id, name, price, is_deleted, seller_seller_id, category_id, created_at) values (UUID'169f84f8-8862-477c-ad27-0b79871deb28', '미니원피스', 50000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c6', 60, '2019-08-25 12:36:05');
insert into item (id, name, price, is_deleted, seller_seller_id, category_id, created_at) values (UUID'169f84f8-8862-477c-ad27-0b79871deb29', '미디원피스', 51000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c6', 61, '2019-08-25 12:36:06');
insert into item (id, name, price, is_deleted, seller_seller_id, category_id, created_at) values (UUID'169f84f8-8862-477c-ad27-0b79871deb30', '롱원피스', 52000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c6', 62, '2019-08-25 12:36:07');
...
INSERT INTO item(id, name, price, is_deleted, seller_seller_id, category_id, created_at) VALUES (UUID'1523bc68-e8f7-4140-b7dd-cbfe622e068a', '뿌린클 순살치킨 세트', 20000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c5', 5, '2019-08-25 12:36:08');
...
INSERT INTO item(id, name, price, is_deleted, seller_seller_id, category_id, created_at) VALUES (UUID'82cdc2eb-5ee8-4bde-8e32-654054b7fc16', '디너코스', 0, 0, UUID'54717bb2-2850-40e5-9889-d17d227f1606', 5, '2019-08-25 12:36:09');
