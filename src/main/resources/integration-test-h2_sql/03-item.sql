...
INSERT INTO item(id, name, price, is_deleted, seller_seller_id, shipping_charge_type, shipping_charge, return_charge, return_address, description, category_id, created_at) VALUES (UUID'1523bc68-e8f7-4140-b7dd-cbfe622e068a', '뿌린클 순살치킨 세트', 20000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c5', 'FREE_SHIPPING', 3000, 2500, '경기 성남시 분당구 정자일로 45','맛잇는 상품', 5, '2019-08-25 12:36:08');
...
INSERT INTO item(id, name, price, is_deleted, seller_seller_id, shipping_charge_type, shipping_charge, return_charge, return_address, description, category_id, created_at) VALUES (UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8', '킹 신발', 20000, 0, UUID'2d68d1d0-ed27-46d2-b858-da3f0aa2e430', 'FREE_SHIPPING', 3000, 2500, '경기 성남시 분당구 정자일로 45','2022 겨울 신상 신발', 39, '2019-08-25 12:36:08');

INSERT INTO item_send_type(id, send_type, item_id) VALUES (5, 'SHIPPING', UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');
INSERT INTO item_send_type(id, send_type, item_id) VALUES (6, 'VISIT', UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');
INSERT INTO item_send_type(id, send_type, item_id) VALUES (7, 'DELIVERY', UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');
INSERT INTO item_send_type(id, send_type, item_id) VALUES (8, 'PICKUP', UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');

INSERT INTO option_group(id, name, is_necessary, is_deleted, item_id) VALUES (UUID'94d51259-cd75-4a2f-be73-13d7f798fb51', '색상', 1, 0, UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');
INSERT INTO option_group(id, name, is_necessary, is_deleted, item_id) VALUES (UUID'86a74cdf-cf9c-4346-9100-9d2096b9e535', '추가 크기', 0, 0, UUID'a103af33-3eb0-4efd-a885-bf7cab7644b8');

INSERT INTO item_option(id, name, price, description, is_deleted, option_group_id) VALUES (UUID'b54ee7af-0c10-4c2f-bce2-2fb62e42269b', '레드', 0, '색상 선택', 0, UUID'94d51259-cd75-4a2f-be73-13d7f798fb51');
INSERT INTO item_option(id, name, price, description, is_deleted, option_group_id) VALUES (UUID'5e4f1976-ca58-4bf7-871c-da0642987317', '블루', 0, '색상 선택', 0, UUID'94d51259-cd75-4a2f-be73-13d7f798fb51');
INSERT INTO item_option(id, name, price, description, is_deleted, option_group_id) VALUES (UUID'85c50bd9-ee4d-40cf-a67e-ffd1acf36599', 'L', 5000, '추가 사이즈 (기본 M)', 0, UUID'86a74cdf-cf9c-4346-9100-9d2096b9e535');
INSERT INTO item_option(id, name, price, description, is_deleted, option_group_id) VALUES (UUID'4395b166-133f-4adc-8f02-56226dc221f9', 'XL', 5000, '추가 사이즈 (기본 M)', 0, UUID'86a74cdf-cf9c-4346-9100-9d2096b9e535');