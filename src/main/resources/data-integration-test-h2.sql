...
---
INSERT INTO shop(id, name, is_deleted) VALUES (X'2D68D1D0ED2746D2B858DA3F0AA2E430', '써머슈슈즈', 0);
...
INSERT INTO item(id, name, price, is_deleted, shop_id, category_id, created_at) VALUES (UUID'1523bc68-e8f7-4140-b7dd-cbfe622e068a', '뿌린클 순살치킨 세트', 20000, 0, UUID'8d41c42a-011b-4525-9864-b24481f985c5', 5, '2019-08-25 12:36:08');
...
INSERT INTO item(id, name, price, is_deleted, shop_id, category_id, created_at) VALUES (UUID'82cdc2eb-5ee8-4bde-8e32-654054b7fc16', '디너코스', 0, 0, UUID'54717bb2-2850-40e5-9889-d17d227f1606', 5, '2019-08-25 12:36:09');
...
--- 유저 등록
INSERT INTO users(user_id, email, password, phone_num, address, user_name, nick_name) VALUES (UUID'672ffb8c-f952-49ec-b65b-4fe3a9c37b28', 'totw2018@naver.com', '1234', '010-4523-6994', '사랑시 행복구 고백동', '류정주', '쩡류');
