...
insert into item (id, name, price, is_deleted, seller_seller_id, shipping_charge_type, shipping_charge, return_charge, return_address, description, category_id, created_at) values (UUID_TO_BIN('169f84f8-8862-477c-ad27-0b79871deb29'), '미디원피스', 51000, 0, UUID_TO_BIN('8d41c42a-011b-4525-9864-b24481f985c6'),  'FREE_SHIPPING', 3000, 2500, '경기 성남시 분당구 정자일로 45', '이쁜 상품', 61, '2019-08-25 12:36:06');
insert into item (id, name, price, is_deleted, seller_seller_id, shipping_charge_type, shipping_charge, return_charge, return_address, description, category_id, created_at) values (UUID_TO_BIN('169f84f8-8862-477c-ad27-0b79871deb30'), '롱원피스', 52000, 0, UUID_TO_BIN('8d41c42a-011b-4525-9864-b24481f985c6'),  'FREE_SHIPPING', 3000, 2500, '경기 성남시 분당구 정자일로 45', '이쁜 상품',62, '2019-08-25 12:36:07');
