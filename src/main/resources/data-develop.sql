...
-- 유저 등록
INSERT INTO USERS(user_id, email, password, phone_num, address, name) VALUES (UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'), 'totw2018@naver.com', '1234', '010-4523-6994', '사랑시 행복구 고백동', '류정주');
...
-- 주문 상품 등록
# insert into order_item(id, amount, count, image_url, name, price) values (UUID_TO_BIN('bf28593f-71ad-4418-b82d-fceea62e9167'), 3, 1, 'http://naver.com', '불고기', 12000);
# insert into order_item(id, amount, count, image_url, name, price) values (UUID_TO_BIN('eb879118-4cfc-41b4-ab3f-451b23f1d74c'), 2, 4, 'http://naver.com', '꽃등심', 25000);
# -- 리뷰 등록
# INSERT INTO REVIEW(review_id, content, is_useful, star_rating, title, item_id, user_id, order_item_id) VALUES (UUID_TO_BIN('ce093467-1e60-45c9-b073-9b684b9dbc06'), '맛있어요',true, 23, 4.0, '추천',UUID_TO_BIN('1523bc68-e8f7-4140-b7dd-cbfe622e068a'), UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'), );
# INSERT INTO REVIEW(review_id, content, is_useful, star_rating, title, item_id, user_id, order_item_id) VALUES (UUID_TO_BIN('ea9e4424-3641-4bcc-b75a-8ded708c5b4f'), '최곤데요?', true, 10, 5.0, '강추',UUID_TO_BIN('1523bc68-e8f7-4140-b7dd-cbfe622e068a'), UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'));
# INSERT INTO REVIEW(review_id, content, is_useful, star_rating, title, item_id, user_id, order_item_id) VALUES (UUID_TO_BIN('885d458c-997a-4e67-b410-39fae05606f4'), '어른들 간식, 아이들 술안주로 딱입니다.', false, 100, 3.0, '그냥 그래요', UUID_TO_BIN('1523bc68-e8f7-4140-b7dd-cbfe622e068a'), UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'));
...
-- 유저 배송지 등록
INSERT INTO delivery_address(id, address, is_default_address, mobile, recipient, requests, user_id) values (UUID_TO_BIN('143e9261-738b-49a4-99e7-94559560cb35'), '사랑시 고백구 행복동', true, '010-4523-6994', '류정주', '오이 빼주세요', UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'));
INSERT INTO delivery_address(id, address, is_default_address, mobile, recipient, requests, user_id) values (UUID_TO_BIN('c89ba92a-6417-4478-aa9c-6adc7b2d3698'), '서울시 성북구 솔샘로7길 19, 103호', true, '010-1111-6994', '김덕배', '오이 제발 빼주세요', UUID_TO_BIN('672ffb8c-f952-49ec-b65b-4fe3a9c37b28'));
